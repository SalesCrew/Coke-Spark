...
## Nachtrag 16.09.2026: Antwortkorrekturen und historische Zeiten

Der letzte Absatz oben beschreibt den Push vom 14.09., nicht den jetzigen lokalen Stand. Die SM-Adminansicht für abgeschlossene Fragebögen ist danach lokal implementiert: [Management-Living-MD](sm-fb-management-living.md). Eine dortige **Antwort**korrektur ändert weder geplante Zeit noch tatsächliche Besuchsstart/-endstempel, Fahrtminuten oder die bestehenden Zeitrevisionen. Bereits gespeicherte Fahrtzeit bleibt in der historischen Mitarbeiter-/Admin-Zeitansicht auch dann erhalten, wenn die Kontoeinstellung später deaktiviert wird; neue Fahrtzeiteingabe bleibt für dieses Konto verborgen. Der isolierte HTTP-/DB-Test prüft korrigierte Aktivitätsantworten und unveränderte Zeitwerte. Kein produktiver Release in diesem Nachtrag.
