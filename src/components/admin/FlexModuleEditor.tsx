...
function FlexQuestionCard({ question, index, isExpanded, onToggle, onUpdate, onDelete, onDragStart, onDragOver, onDrop, onContextTypeMenu, dropTarget, allQuestions }: {
...
export function FlexModuleEditor({ onClose, onSave, existingModule, existingQuestions = [] }: FlexModuleEditorProps) {
